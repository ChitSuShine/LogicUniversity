...
import com.nusiss.team10ad.LogicUniversity.Clerk.ApproveCollectionPoint;
import com.nusiss.team10ad.LogicUniversity.Clerk.ClerkDashboard;
import com.nusiss.team10ad.LogicUniversity.Clerk.Inventory;
import com.nusiss.team10ad.LogicUniversity.DepartmentHead.AssignDepRep;
import com.nusiss.team10ad.LogicUniversity.DepartmentHead.OrderHistory;
import com.nusiss.team10ad.LogicUniversity.DepartmentHead.HodDashboard;
//import com.example.team10ad.LogicUniversity.DepartmentHead.HodReportFragment;
import com.nusiss.team10ad.LogicUniversity.DepartmentHead.HodRequisitionList;
import com.nusiss.team10ad.LogicUniversity.DepartmentHead.ReqListForTrackingOrder;
import com.nusiss.team10ad.LogicUniversity.DepartmentRep.RepScanQRFragment;
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.isSuccessful()) {
                    ...
                    if (user.getRole() == Constants.CLERK_ROLE) {
                        ...
                        nvDrawer.inflateMenu(R.menu.activity_home_other);
                        nvDrawer.setCheckedItem(R.id.logout);
                    }
                } else {
