...
import com.nusiss.team10ad.LogicUniversity.Util.HodReqListAdapter;
...
//Author: Win Yadanar Htet
public class HodRequisitionList extends Fragment {
    ...
    public HodRequisitionList() { }

    public static HodRequisitionList newInstance(String param1, String param2) {
        HodRequisitionList fragment = new HodRequisitionList();
